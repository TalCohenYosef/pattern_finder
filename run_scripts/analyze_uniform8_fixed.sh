...
echo "Analyzing pattern matching results for uniform_deg_8..."
echo "======================================================"

# Configuration
PATTERNS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_uniform_deg_8/patterns"
LOGS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_uniform_deg_8/logs"
OUTPUT_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_uniform_deg_8"
SUBGRAPH_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/Graph-Search"

# Target graphs
TARGET_GRAPHS=(
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_uniform_deg_8/G_induced.json"
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_uniform_deg_8/G_non_induced.json"
)
...
MASTER_SUMMARY="$OUTPUT_DIR/MASTER_SUMMARY_UNIFORM8_FIXED.log"
echo "COMPREHENSIVE PATTERN ANALYSIS SUMMARY - UNIFORM DEG 8 (FIXED)" > "$MASTER_SUMMARY"
echo "=================================================================" >> "$MASTER_SUMMARY"
...
echo "Master summary: MASTER_SUMMARY_UNIFORM8_FIXED.log"
echo ""
echo "Fixed pattern analysis for input_color_uniform_deg_8 completed!"
