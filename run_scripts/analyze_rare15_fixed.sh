...
echo "Analyzing pattern matching results for rare_deg_15..."
echo "======================================================"

# Configuration
PATTERNS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_15/patterns"
LOGS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_15/logs"
OUTPUT_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_15"
SUBGRAPH_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/Graph-Search"

# Target graphs
TARGET_GRAPHS=(
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_rare_deg_15/G_induced.json"
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_rare_deg_15/G_non_induced.json"
)
...
MASTER_SUMMARY="$OUTPUT_DIR/MASTER_SUMMARY_rare15_FIXED.log"
echo "COMPREHENSIVE PATTERN ANALYSIS SUMMARY - rare DEG 15 (FIXED)" > "$MASTER_SUMMARY"
echo "=================================================================" >> "$MASTER_SUMMARY"
echo "Date: $(date)" >> "$MASTER_SUMMARY"
echo "Total patterns tested: 1550" >> "$MASTER_SUMMARY"
...
echo "Master summary: MASTER_SUMMARY_rare15_FIXED.log"
echo ""
echo "Fixed pattern analysis for input_color_rare_deg_15 completed!"
