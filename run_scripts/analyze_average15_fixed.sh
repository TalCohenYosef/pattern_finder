...
echo "Analyzing pattern matching results for average_deg_15..."
echo "======================================================"

# Configuration
PATTERNS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_average_deg_15/patterns"
LOGS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_average_deg_15/logs"
OUTPUT_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_average_deg_15"
SUBGRAPH_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/Graph-Search"

# Target graphs
TARGET_GRAPHS=(
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_average_deg_15/G_induced.json"
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_average_deg_15/G_non_induced.json"
)
...
MASTER_SUMMARY="$OUTPUT_DIR/MASTER_SUMMARY_average15_FIXED.log"
echo "COMPREHENSIVE PATTERN ANALYSIS SUMMARY - average DEG 15 (FIXED)" > "$MASTER_SUMMARY"
echo "=================================================================" >> "$MASTER_SUMMARY"
...
echo "Master summary: MASTER_SUMMARY_average15_FIXED.log"
echo ""
echo "Fixed pattern analysis for input_color_average_deg_15 completed!"
