...
echo "Analyzing pattern matching results for rare_deg_3..."
echo "======================================================"
...
MASTER_SUMMARY="$OUTPUT_DIR/MASTER_SUMMARY_rare3_FIXED.log"
echo "COMPREHENSIVE PATTERN ANALYSIS SUMMARY - rare DEG 3 (FIXED)" > "$MASTER_SUMMARY"
echo "=================================================================" >> "$MASTER_SUMMARY"
...
echo "Master summary: MASTER_SUMMARY_rare3_FIXED.log"
echo ""
echo "Fixed pattern analysis for input_color_rare_deg_3 completed!"
