...
echo "Analyzing pattern matching results for rare_deg_5..."
echo "======================================================"

# Configuration
PATTERNS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_5/patterns"
LOGS_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_5/logs"
OUTPUT_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/results/OUTPUT_input_color_rare_deg_5"
SUBGRAPH_DIR="/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/Graph-Search"

# Target graphs
TARGET_GRAPHS=(
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_rare_deg_5/G_induced.json"
    "/home/cohent59/PROJECT_RUN_PATTERN/pattern_finder/local_tests/input_color_rare_deg_5/G_non_induced.json"
)
...
MASTER_SUMMARY="$OUTPUT_DIR/MASTER_SUMMARY_rare5_FIXED.log"
echo "COMPREHENSIVE PATTERN ANALYSIS SUMMARY - rare DEG 5 (FIXED)" > "$MASTER_SUMMARY"
echo "=================================================================" >> "$MASTER_SUMMARY"
...
echo "Master summary: MASTER_SUMMARY_rare5_FIXED.log"
echo ""
echo "Fixed pattern analysis for input_color_rare_deg_5 completed!"
