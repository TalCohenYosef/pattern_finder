...
public:
     ...
     */
    static std::vector<int32_t> map_colors(Graph& graph);
     ...
     * @return color_map  color_map[new_id] == original colour value.
     */
    static std::vector<int32_t> map_colors(Graph& a, Graph& b);
     ...
     * @return color_map  color_map[new_id] == original colour value.
     */
    static std::vector<int32_t> map_colors(std::vector<Graph>& graphs);
     ...
     */
    static std::vector<uint32_t> find_initial_matches(const Graph& s,
                                                      uint32_t     color);
...
private:
    ...
    static void count_vertex_colors(const Graph& graph,
